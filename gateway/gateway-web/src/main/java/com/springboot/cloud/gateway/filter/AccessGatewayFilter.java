...
public class AccessGatewayFilter implements GlobalFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        log.debug("url:{},method:{},headers:{}:authentication:{}",
                url, method, request.getHeaders(),authentication);
        //不需要网关签权的url
        ...
        if (permissionService.permission(authentication, url, method)) {
            ...
            builder.header(X_CLIENT_TOKEN, "TODO zhoutaoo add service invoke athentication添加服务间简单认证");
